...
async function handleApi(request, kv) {
    ...
    if (request.method === 'POST' && path === '/api/config') {
        ...
        sites.push({ id: newId, name: body.name, url: body.url, catelog: body.catelog, logo: body.logo || '', desc: body.desc || '', sort_order: 9999 });
